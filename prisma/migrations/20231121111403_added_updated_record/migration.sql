...
INSERT INTO "new_variantShipDateData" ("b2bProduct", "bundleProduct", "dateAvailable", "id", "overrideMessage", "processingTime", "productHandle", "productId", "productVariantId", "shipDateMessage", "shop", "title", "updated") SELECT "b2bProduct", "bundleProduct", "dateAvailable", "id", "overrideMessage", "processingTime", "productHandle", "productId", "productVariantId", "shipDateMessage", "shop", "title", "updated" FROM "variantShipDateData";
